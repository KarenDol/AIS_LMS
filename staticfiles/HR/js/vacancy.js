document.addEventListener('DOMContentLoaded', function () {
    ...
    for (let i = 0; i < positions.length; i += 2) {
        ...
        if (i + 1 < positions.length) {
            console.log(`Pairing with index: ${i}, position:`, i + 1);
            addPositions(positions[i], positions[i + 1]);
        } else {
            console.log(`Single position at index: ${i}`);
        ...
        card_block.innerHTML = `
            <div class="card" data-id="${pos1.id}">
                <div class="card-content"">
                    <h3>${pos1.title}</h3>
                    <p class="description">от ${salary_to_text(pos1.salary)}</p>
            ...
            <div class="card" data-id="${pos2.id}">
                <div class="card-content">
                    <h3>${pos2.title}</h3>
                    <p class="description">от ${salary_to_text(pos2.salary)}</p>
